...
- [x] Preview รูปเต็มจอก่อนยืนยันแนบ ทุกจุดที่มีช่องเลือกรูป (`previewPhotosBeforeConfirm()` โมดัลกลาง ใช้ร่วมกัน 7 จุด: แนบหลักฐานตอนกรอกเอง, ถ่ายรูป/เลือกรูปใบเสร็จ OCR, เพิ่มรูปย้อนหลังในแท็บรายการรายจ่าย, ฟอร์มเพิ่มทรัพย์สิน, เพิ่มรูปย้อนหลังทรัพย์สิน, ฟอร์มจ่ายหนี้, เพิ่มรูปย้อนหลังงวดจ่ายหนี้) — เดิมกดเลือกรูปจาก grid view ของมือถือแล้วอัปโหลด/แนบทันที เห็นรูปเล็กอาจเลือกผิดรูป ตอนนี้ต้องเห็นรูปขยายเต็มจอ + กดยืนยันก่อนเสมอ ลบรูปที่ไม่ต้องการออกจาก selection ได้ก่อนยืนยันด้วย (ปุ่ม ✕ มุมขวาบนต่อรูป, โชว์เฉพาะตอนเลือกมากกว่า 1 รูป) กดยกเลิกแล้วไม่มีการอัปโหลด/แนบใดๆ เกิดขึ้น — ทดสอบผ่าน throwaway account: multi-file preview + ลบรูปหนึ่งออกก่อนยืนยัน → แนบเหลือแค่รูปที่เหลือถูกต้อง, cancel path ไม่แนบ/ไม่เรียก OCR เลย (ยืนยัน `ocr-status` ว่างเปล่าหลัง cancel), single-file preview (ช่อง OCR) ไม่โชว์ปุ่มลบ (มีรูปเดียวลบไม่ได้อยู่แล้ว), mobile 375px รูป/ปุ่มไม่ล้นจอ
