...
7. **สินค้า** — 2 การ์ด: (a) เพิ่ม/ดูสินค้า พร้อมหน่วยซื้อ→หน่วยใช้งาน+อัตราแปลง+ราคาล่าสุดต่อหน่วยใช้งาน (คำนวณจาก expense_item ล่าสุดที่ผูกไว้ — ใช้ `moneyPerUnit()` โชว์ทศนิยมได้ถึง 4 ตำแหน่ง ต่างจาก `money()` ปกติที่ปัด 2 ตำแหน่งแล้วจะโชว์ "0.00" เวลาราคาต่อหน่วยเล็กมากๆ เช่น บาท/กรัม — ดูข้อ 11 บั๊กที่เจอ) (b) รายชื่อรายจ่ายที่ยังไม่ผูกกับสินค้า (group by ชื่อ เรียงตัวอักษร) เลือกหลายชื่อ + ผูกเข้าสินค้าเดียวกันทีเดียว
