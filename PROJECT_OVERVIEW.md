...
2. **เพิ่มรายรับ** — เลือกช่องทาง + ประเภทยอด (ตามระบบ/โอนเข้าจริง) → insert `income_entries`
3. **กระทบยอด** — เลือกเดือน → เทียบยอดตามระบบ vs โอนเข้าจริง แยก 3 ช่องทาง
4. **รายงานเดือน** — สรุปรายจ่ายจริงตามหมวดเทียบ cost model, รายจ่ายแยกตามบัญชีที่จ่าย, รายรับ-รายจ่ายรวม, มูลค่าทรัพย์สินสุทธิ, หนี้สินคงค้างแยกตามเจ้าหนี้
5. **ทรัพย์สิน/หนี้** — 2 การ์ด: (a) เพิ่ม/ดูทรัพย์สิน พร้อมค่าเสื่อมสะสม+มูลค่าคงเหลือคำนวณสด (b) เพิ่ม/ดูหนี้สิน พร้อมบันทึกจ่ายเป็นงวดๆ ต่อรายการ
